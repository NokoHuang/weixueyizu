...
import com.weixue.Utils.NumToChines;
...
public class MuPDFActivity extends Activity {
	...
	// private ImageButton mIbOutlineButton;
	// private ImageButton mAddMarkButton;
	// private ImageButton mIbAddMarkButton;
	// private ImageButton mCheckMarkButton;
	// private ImageButton mIbCheckMarkButton;
	...
	public void createUI(Bundle savedInstanceState) {
		...
		// if (core.hasOutline()) {
		// mOutlineButton.setOnClickListener(new OnMenuItemClickListener(1));
		// } else {
		// mIbOutlineButton.setVisibility(View.GONE);
		// RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams)
		// mOutlineButton
		// .getLayoutParams();
		// lp.width = Constants.dip2px(this, 10);
		// mOutlineButton.setLayoutParams(lp);
		// }
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 1006:// 书签
			if (resultCode == RESULT_OK) {
				mDocView.setDisplayedViewIndex(Constants.pagerIndex - 1);
			}
			break;
		}
	...
	private void makeButtonsView() {
		...
		// mBtnBack = (ImageButton) mButtonsView.findViewById(R.id.back);
		...
		// mIbOutlineButton = (ImageButton) mButtonsView
		// .findViewById(R.id.ib_outlineButton);
		// mAddMarkButton = (ImageButton) mButtonsView
		// .findViewById(R.id.addBookmark);
		// mIbAddMarkButton = (ImageButton) mButtonsView
		// .findViewById(R.id.ib_addBookmark);
		// mCheckMarkButton = (ImageButton) mButtonsView
		// .findViewById(R.id.checkBookmark);
		// mIbCheckMarkButton = (ImageButton) mButtonsView
		// .findViewById(R.id.ib_checkBookmark);
		//
		// mAddMarkButton.setOnClickListener(new OnMenuItemClickListener(2));//
		// 添加书签
		// mCheckMarkButton.setOnClickListener(new
		// OnMenuItemClickListener(3));// 查看书签
	...
	// *
	// */
	// private class OnMenuItemClickListener implements OnClickListener {
	// int type;// 1目录 2添加书签 3查看书签
	//
	// public OnMenuItemClickListener(int type) {
	// this.type = type;
	// }
	//
	// @Override
	...
	// dialog = new Dialog(MuPDFActivity.this);
	// View view = MuPDFActivity.this.getLayoutInflater().inflate(
	// R.layout.add_bookmark, null);
	...
	// lp.width = Constants.mScreenWidth * 5 / 6;
	// window.setAttributes(lp);
	//
	// final EditText editText = (EditText) view
	// .findViewById(R.id.bookmark_name);
	//
	// pagerIndex = mDocView.getDisplayedViewIndex() + 1;
	// pager = "第" + numTool.getChinesByNum(String.valueOf(pagerIndex)) + "页";
	// editText.setText(pager);
	//
	...
	//
	// Button mBtnOk = (Button) view.findViewById(R.id.ok);
	// Button mBtnCancle = (Button) view.findViewById(R.id.cancle);
	//
	// mBtnOk.setOnClickListener(new OnClickListener() {
	// @Override
	// public void onClick(View arg0) {
	// String value = editText.getText().toString();
	// if (!saveBookmark(value, pagerIndex, editText.getText()
	// .toString()))
	// return;
	// Toast.makeText(MuPDFActivity.this, "添加书签成功",
	// Toast.LENGTH_SHORT).show();
	// dialog.dismiss();
	// hideButtons();
	// mFilenameView.requestFocus();
	// imm.hideSoftInputFromWindow(editText.getWindowToken(),
	// InputMethodManager.HIDE_NOT_ALWAYS);//收回软键盘
	// }
	// });
	...
	// * 保存书签
	// */
	// private boolean saveBookmark(String value, int pagerIndex, String pager)
	// {
	// if (value == null || value.equals("")) {
	// Toast.makeText(MuPDFActivity.this, "请输入书签名", Toast.LENGTH_SHORT)
	// .show();
	// return false;
	// }
	//
	// Cursor c = dbHelper.Query("bookmark", null,
	// "phonenum=? and id=? and name=? and pagerIndex=? and pager=?",
	// new String[] { UserInfo.phoneNum, String.valueOf(id), title,
	// String.valueOf(pagerIndex), pager }, null, null, null);
	// if (c.moveToNext()) {// 已存在
	// return true;
	// }
	//
	...
	// cv.put("phonenum", UserInfo.phoneNum);
	// cv.put("pagerIndex", String.valueOf(pagerIndex));
	// cv.put("name", title);
	// cv.put("pager", pager);
	//
	// dbHelper.Insert(cv, "bookmark");
	//
	// return true;
	// }
	//
	...
	// Cursor c = dbHelper.Query("bookmark", new String[] { "pager",
	// "pagerIndex" }, "phonenum=? and id=? and name=?", new String[] {
	// UserInfo.phoneNum, String.valueOf(id), title }, null, null,
	// null);
	// ArrayList<BookmarkModel> pagers = new ArrayList<BookmarkModel>();
	// while (c.moveToNext()) {// 存在
	// pagers.add(new BookmarkModel(c.getInt(1), c.getString(0)));
	// }
