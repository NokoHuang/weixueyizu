 ...
 *
 */
public class ChoiceRecoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.choice_reco_page);
		init();
	...
	public void init(){
		mContext=this;
		lv_lesson =(ListView) findViewById(R.id.lesson_list);
	...
	public void loadData(List<Course> li){
		...
		adapter=new LessonAdapter(ChoiceRecoActivity.this,li);
