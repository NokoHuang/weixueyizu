...
public class XListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private final static int PULL_LOAD_MORE_DELTA = 1;//50; // when pull up >= 50px
    // at bottom, trigger
    // load more.
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mEnablePullRefresh && getFirstVisiblePosition() == 0
                    ...
                    //terry add mEnablePullRefresh, the first item is showing, header has shown or pull down.
                    updateHeaderHeight(deltaY / OFFSET_RADIO);
                    invokeOnScrolling();
                } else if (mEnablePullLoad && getLastVisiblePosition() == mTotalItemCount - 1
                        && (mFooterView.getBottomMargin() > 0 || deltaY < 0)) {
                    //terry add mEnablePullLoad, last item, already pulled up or want to pull up.
